    ...
    <section class="catalog" id="catalog">
        ...
        <div class="site-wrapper">
            <div class="container">
                <div class="box">
                    <ul>
                        <li><a href="category.php?id=4" class="father-category">
                ...
                <div class="box">
                    <ul>
                        <li><a href="category.php?id=1" class="father-category">
                ...
                <div class="box">
                    <ul>
                        <li><a href="category.php?id=2" class="father-category">
                ...
                <div class="box">
                    <ul>
                        <li><a href="category.php?id=3" class="father-category">
